...
namespace RPBNet.NetworkBase.Server
{
    ...
    {
        private static readonly Dictionary<int, Func<ByteBuffer,RPBPacket>> _packetFactory = new Dictionary<int,Func<ByteBuffer,RPBPacket>>();
        private static readonly Dictionary<int,Action<RPBPacket,IConnection>> _actions = new Dictionary<int, Action<RPBPacket, IConnection>>();
